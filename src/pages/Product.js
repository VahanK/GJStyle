...
export default function ProductDetail() {
    ...
    const addToBag = async () => {
        try {
            ...
            let cartDetailsResponse = await axios.get(`http://0000:8055/items/cart_details?filter[cart]=${cartId}`);
            ...
            if (existingItem) {
                ...
                await axios.patch(`http://0000:8055/items/cart_details/${existingItem.id}`, {
                ...
                await axios.post('http://0000:8055/items/cart_details', productData);
            }
        } catch (error) {
